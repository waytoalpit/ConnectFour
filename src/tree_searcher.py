...
'''
As we have implemented minimax algorithm, so leaf nodes always return the positive value
irrespective of leaf nodes being MIN or MAX.
'''
def tree_eval(node):
    """
